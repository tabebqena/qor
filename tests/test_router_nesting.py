...
def test_build_routes_nesting():
    ...
    assert first_about.raw_path == "/first/first_about/"  # because the input url has trailing slash
    ...
    assert first_privacy.raw_path == "/first//first_privacy/"   # because tha input has double slashes
    ...
    assert second_privacy.raw_path == "/first/second//second_privacy/" # because tha input has double slashes
